        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3 text-sm">
              <p>
                <strong>Price per Square Foot:</strong> A key metric for comparing property values in the same area.
              </p>
              <p>
                This {formatNumber(area)} {areaUnit} property at {formatCurrency(totalPrice)} costs{" "}
                {formatCurrency(pricePerSqFt)} per square foot.
              </p>
              <p>
                <strong>Market Comparison:</strong> Compare this rate with similar properties in the area to determine
